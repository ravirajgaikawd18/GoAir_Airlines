function RegValidate(){
    ...
    var isPasswordEmpty = CheckEmpty("password", "ErrorForPassword", "password is required");
    if(isPasswordEmpty == false){
            var expectedLength = 6;
            var isPasswordLengthOk = CheckLength("password", "ErrorForPassword", "Min 6 chars required", expectedLength);
    }
    ...
    console.log(isPasswordLengthOk);
    ...
    if(isUserNameLengthOk && isPasswordLengthOk && isPhoneLengthOk && isAdharLengthOk){
